...
author: "Helena Khalil (PID: A16313711)"
format: pdf
---

## Using GGPlot

The ggplot2 pakage needs to be installed as it does not come with R"out of the box" 
...
p <- ggplot(genes) + 
    ...
    geom_point() 
p + scale_colour_manual( values=c("magenta","skyblue","forestgreen") ) +
